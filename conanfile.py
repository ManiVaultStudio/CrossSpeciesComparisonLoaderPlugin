...
class CrossSpeciesComparisonLoaderPluginConan(ConanFile):
    """Class to package CrossSpeciesComparisonLoaderPlugin using conan
    ...
    scm = {"type": "git", "subfolder": "hdps/CrossSpeciesComparisonLoaderPlugin", "url": "auto", "revision": "auto"}
    ...
    def build(self):
        ...
        # The CrossSpeciesComparisonLoaderPlugin plugins expect the HDPS package to be in this install dir
